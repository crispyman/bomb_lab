...
{
"To display the integer variable in hex type: p/x <varName>",
...
"To display the a character whose encoding is hex 60 type: p/c 0x60",
...
"To get into layout mode type: layout src",
"To get out of layout mode type: ctrl-x-a",
